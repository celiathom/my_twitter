    ...
    <div class="real-content">
        <div class="container">
            <div class="column col1">
                <ul>
                    <li><a class="btn-nolive" href="../Views/HomeView.php"><img src="../Views/imgs/maison.png"> Home</a></li>
                    ...
                    <li><a class="btn-live" href="../Views/AccountView.php"><img src="../Views/imgs/profile.png"> Profile</a></li>
            ...
            <div class="column col2"> 
                <div class="profile-container">
                    <div class="usertitle">
                        <img src="../Views/imgs/fleche.png" class="flecheimg">
                        <div class="userinfo">
                            <span class="titleusername"><?php echo htmlspecialchars($user['firstname'] . ' ' . $user['lastname']); ?></span>
                            <span class="postcount"><?php echo number_format($user['total_tweets']); ?> posts</span>
                        </div>
                    </div>
                    <div class="banner">
                        <img src="<?php echo $bannerPath; ?>" alt="Bannière">
                    </div>
                    <div class="logo_user">
                        <img src="<?php echo $profilePicturePath; ?>" class="img_logo" alt="Photo de profil">
                        <a class="btn_edit" href="update_profile.php">Edit Profil</a>
                        <div class="bio">
                            <span class="user-title-bio"><?php echo htmlspecialchars($user['firstname'] . ' ' . $user['lastname']); ?></span>
                            <span class="mention-user">@<?php echo isset($user['username']) ? htmlspecialchars($user['username']) : "Utilisateur inconnu"; ?></span>
                            <span class="bio_user"><?php echo htmlspecialchars($user['biography'] ?? ""); ?></span>
                            <span class="join_date"><img src="../Views/imgs/date.png"> Joined <?php echo date("F Y", strtotime($user['creation_date'])); ?></span>
                            <span><strong><?php echo number_format($user['total_following']); ?></strong> Following <strong><?php echo number_format($user['total_followers']); ?></strong> Followers</span>
                        </div>
                    </div>
                    <div class="btn-account">
                        <button class="btn-col2">AIRS</button>
                        <button class="btn-col2">Replies</button>
                        <button class="btn-col2">Media</button>
                        <button class="btn-col2">Likes</button>
                    </div>
                    <div class="tweets-container">
                    <?php if (!empty($tweets)): ?>
                        <?php foreach ($tweets as $tweet): ?>
                            <?php if (isset($tweet['id_user']) && isset($_SESSION['user_data']['id']) && $tweet['id_user'] == $_SESSION['user_data']['id']): ?>                                <div class="tweet-embed">
